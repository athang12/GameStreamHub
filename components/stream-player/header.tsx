...
import { UserAvatar, UserAvatarSkeleton } from "../avatar";
                ...
                <div className="space-y-1">
                    ...
                    </p>
                    {
                        isLive?(
                            ...
                            <p className="font-semibold text-xs text-muted-foreground pl-2">
                              Offline
                            </p>
                        )
                    }
